...
# ตั้งค่าหน้าเว็บ
st.set_page_config(
    page_title="คำนวณภาษีเงินได้บุคคลธรรมดา 2568 (ยื่นในปี 2569)",
    page_icon="💰",
    layout="wide",
...
# หน้าคำนวณภาษี
if page == "คำนวณภาษี":
    st.markdown('<div class="main-header">💰 คำนวณภาษีเงินได้บุคคลธรรมดา ปี 2568 (ยื่นในปี 2569)</div>', unsafe_allow_html=True)
    st.info("📅 **ระยะเวลายื่นภาษี**: ภาษีปี 2568 ต้องยื่นแบบแสดงรายการภาษีระหว่าง **1 มกราคม - 31 มีนาคม 2569** (ยื่นแบบออนไลน์ถึง **8 เมษายน 2569**)")
